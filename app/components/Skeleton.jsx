...
export function SkeletonWidget({ lines = 3, style }) {
  return (
...
export function SkeletonCard({ count = 3, style }) {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12, padding: '12px 0', ...style }}>
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} style={{ padding: 12, borderRadius: 8, background: 'rgba(255,255,255,0.02)' }}>
...
export function SkeletonPage({ style }) {
  return (
