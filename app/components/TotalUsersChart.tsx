  ...
  return (
    <div className="total-users-chart-container">
            ...
            <ResponsiveContainer width="100%" height={280}>
              <ComposedChart data={predictions.filteredData} margin={{ top: 20, right: 10, left: 0, bottom: 20 }}>
                    ...
                    if (payload.isCurrentDay) {
                      return (
                        <g key={`dot-${payload.date}`}>
                          ...
                          <circle cx={cx} cy={cy} r={5} fill="var(--color-primary)" stroke="var(--background)" strokeWidth={2} />
                        </g>
                      )
                    }
                    return null
                ...
                <Line
                  ...
                  activeDot={{ r: 4, fill: '#22c55e', stroke: 'var(--background)', strokeWidth: 2 }}
                />
              </ComposedChart>
            </ResponsiveContainer>
          )}
      ...
      <style jsx>{`
        ...
        .legend-dot.current { background: var(--color-primary); border: 2px solid var(--background); box-sizing: border-box; }
