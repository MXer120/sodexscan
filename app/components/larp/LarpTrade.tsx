...
export default function LarpTrade({ wallet }) {
  ...
  useEffect(() => {
    ...
    const chartBg = cs.getPropertyValue('--sodex-bg-main').trim() || '#121212'
    const textColor = cs.getPropertyValue('--sodex-text-secondary').trim() || '#A3A3A3'
    const gridColor = cs.getPropertyValue('--sodex-border-primary').trim() || 'rgba(255,255,255,0.04)'
    const borderColor = cs.getPropertyValue('--sodex-border-secondary').trim() || 'rgba(255,255,255,0.1)'
