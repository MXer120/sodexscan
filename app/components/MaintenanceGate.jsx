  ...
  return (
    <div className={`mnt-root ${mounted ? 'mnt-root--in' : ''}`}>
      <div className="mnt-body">
        ...
        <div className="mnt-center" style={{ '--stagger': 0 }}>
          <div className="mnt-icon mnt-stagger" style={{ '--i': 0 }}>
          ...
          <h1 className="mnt-title mnt-stagger" style={{ '--i': 1 }}>Upgrade in progress</h1>
          <p className="mnt-sub mnt-stagger" style={{ '--i': 2 }}>
            CommunityScan SoDEX is currently offline while we roll out the latest upgrades.
            <br />We'll be back shortly.
          </p>
          <div className="mnt-pulse mnt-stagger" style={{ '--i': 3 }}>
            <span /><span /><span />
          </div>
          <p className="mnt-tagline mnt-stagger" style={{ '--i': 4 }}>CommunityScan SoDEX · Data Intelligence Layer</p>
        </div>

        <form className="mnt-form mnt-stagger" style={{ '--i': 5 }} onSubmit={handleLogin}>
