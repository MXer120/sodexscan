...
const aiModels = [
  { id: "square-3", label: "CommunityScan AI 3.0", icon: SparklesIcon },
  { id: "square-turbo", label: "CommunityScan AI Turbo", icon: SparklesIcon },
  { id: "square-pro", label: "CommunityScan AI Pro", icon: SparklesIcon },
  { id: "square-ultra", label: "CommunityScan AI Ultra", icon: SparklesIcon },
];
