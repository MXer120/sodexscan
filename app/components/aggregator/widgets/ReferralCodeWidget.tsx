...
interface ReferralCodeSettings { showCode?: boolean; showDiscord?: boolean; showTelegram?: boolean }

export default function ReferralCodeWidget({ settings = {} }: { settings?: ReferralCodeSettings }) {
