...
function WidgetWrapper({ instanceId, config, onRemove, onUpdateConfig, recentColors, onAddRecentColor, resolvedWalletAddress, editMode = true, layoutItem, onResizeWidget, rowHeight = 80 }) {
