  ...
  return (
    <Sidebar collapsible="offcanvas" className="lg:!border-r-0" {...props}>
      ...
      <SidebarFooter className="px-5 pb-5">
        <Link
          href="https://www.communityscan-sodex.com"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center justify-center gap-2 h-9 px-4 rounded-md border border-border bg-background hover:bg-muted shadow-sm text-sm font-medium w-full"
        >
