...
import { topPerformers } from "@/app/mock-data/dashboard";
...
const barStyles = [
  ...
  },
  {
    ...
    bgGradient:
      "bg-gradient-to-r from-cyan-400/30 via-cyan-400/15 to-transparent",
    isDashed: true,
  },
  {
    borderColor: "border-green-400",
    bgGradient:
      "bg-gradient-to-r from-green-400/30 via-green-400/15 to-transparent",
    isDashed: true,
  },
  {
    borderColor: "border-amber-400",
    bgGradient:
      "bg-gradient-to-r from-amber-400/30 via-amber-400/15 to-transparent",
    isDashed: true,
  },
  {
    borderColor: "border-purple-400",
    bgGradient:
      "bg-gradient-to-r from-purple-400/30 via-purple-400/15 to-transparent",
    isDashed: true,
  },
  {
    borderColor: "border-rose-400",
    bgGradient:
      "bg-gradient-to-r from-rose-400/30 via-rose-400/15 to-transparent",
    isDashed: true,
  },
];
