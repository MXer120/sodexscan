...
const PLANNED = [
  ...
  { id: 'get_referral_code', name: 'My Referral Code', category: 'Referral', status: 'planned', tier: 'user', shortDescription: 'Own referral code + summary.' },
  { id: 'get_referral_stats', name: 'Referral Stats', category: 'Referral', status: 'planned', tier: 'user', shortDescription: 'Earnings + active count + top referral.' },
  { id: 'get_referral_list', name: 'Referral List', category: 'Referral', status: 'planned', tier: 'user', shortDescription: 'Referred wallets with 30D PnL/volume.' },
