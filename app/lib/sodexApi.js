...
/** Open perps orders */
export const perpsOrders = (address, symbol) =>
...
/** Order history */
export const perpsOrderHistory = (address, { symbol, startTime, endTime, limit = 100 } = {}) => {
...
export const perpsPositionHistory = (address, { symbol, startTime, endTime, limit = 100 } = {}) => {
  const params = new URLSearchParams()
  if (symbol) params.set('symbol', symbol)
  if (startTime) params.set('startTime', startTime)
  if (endTime) params.set('endTime', endTime)
...
/** Trade fills */
export const perpsTrades = (address, { symbol, startTime, endTime, limit = 100 } = {}) => {
  const params = new URLSearchParams()
  if (symbol) params.set('symbol', symbol)
  if (startTime) params.set('startTime', startTime)
  if (endTime) params.set('endTime', endTime)
...
/** Funding history */
export const perpsFundings = (address, { symbol, startTime, endTime, limit = 100 } = {}) => {
  const params = new URLSearchParams()
  if (symbol) params.set('symbol', symbol)
  if (startTime) params.set('startTime', startTime)
  if (endTime) params.set('endTime', endTime)
...
/** Spot order history */
export const spotOrderHistory = (address, { symbol, startTime, endTime, limit = 100 } = {}) => {
  const params = new URLSearchParams()
  if (symbol) params.set('symbol', symbol)
  if (startTime) params.set('startTime', startTime)
  if (endTime) params.set('endTime', endTime)
...
/** Spot trade fills */
export const spotTrades = (address, { symbol, startTime, endTime, limit = 100 } = {}) => {
  const params = new URLSearchParams()
  if (symbol) params.set('symbol', symbol)
  if (startTime) params.set('startTime', startTime)
  if (endTime) params.set('endTime', endTime)
