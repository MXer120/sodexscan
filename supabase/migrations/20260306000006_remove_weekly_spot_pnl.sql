-- Remove weekly_spot_pnl and weekly_sodex_pnl from get_weekly_leaderboard
-- These are unreliable for historical weeks (sodex_pnl not backfilled).
-- PnL in weekly views always uses futures PnL (weekly_pnl).
