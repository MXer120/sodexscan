-- Fix get_weekly_leaderboard: sort by weekly delta values, not cumulative rank.
-- Also sort by total sodex volume (spot+futures) by default for "volume" sort.
    ...
    SELECT json_agg(row_to_json(t)) INTO result FROM (
      ...
      ORDER BY
        CASE WHEN p_sort = 'volume'
          THEN GREATEST(cw.sodex_total_volume, cw.cumulative_volume)
